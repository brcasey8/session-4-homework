...
app.controller("NavController", function( $scope, $http ) {
  ...
  //   $scope.user = response.data //setting user = to api data from github
  // }

  // $http.get('https://api.github.com/users/brcasey8') //retriving data from github
  // .then( onUserComplete ) //running function after retriving

  var brewTypes = function (response){
